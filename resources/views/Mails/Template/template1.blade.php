                            ...
                            <tr>
                                <td>
                                    <table class="row-content stack" align="center" border="0" cellpadding="0"
                                        ...
                                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; color: #000000; width: 505px;"
                                        width="505">
                                        <tbody>
                                            <tr>
                                                <td class="column column-1" width="100%"
                                                            ...
                                                            <td class="pad"
                                                                ...
                                                                <div class="alignment" align="center"
                                                                    style="line-height:10px"><img
                                                                        src="{{ asset('public/img/logos/logoComplet.svg') }}"
                                                                        alt="ShalomFinance"
                                                    ...
                                                    <table class="paragraph_block block-2" width="100%" border="0"
                                                        ...
                                                        <tr>
                                                            <td class="pad">
                                                                <div
                                                                    style="color:#036640;font-size:18px;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;font-weight:400;line-height:120%;text-align:left;direction:ltr;letter-spacing:0px;mso-line-height-alt:21.599999999999998px;">
                                                                    @yield('contenu')
                                                                </div>
                                                            </td>
                                                        </tr>
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <table class="row-content stack" align="center" border="0" cellpadding="0"
                                        cellspacing="0" role="presentation"
                                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #0d7a50; color: #000000; border-radius: 0; width: 505px;"
                                        width="505">
                                        <tbody>
                                            <tr>
                                                <td class="column column-1" width="100%"
                                                        ...
                                                        <tr>
                                                            <td class="pad">
                                                                <div
                                                                    ...
                                                                    <p style="margin: 0;">{{ $Params->adresses }}</p>
                                                                    <p style="margin: 0;">{{ $Params->telephone }}</p>
                                                                    <p style="margin: 0;">{{ $Params->email }}</p>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
